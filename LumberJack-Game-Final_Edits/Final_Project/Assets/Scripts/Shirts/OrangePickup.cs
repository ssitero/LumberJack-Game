...
public class OrangePickup : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.CompareTag("Player"))
        {
            ...
            orange.transform.position = other.gameObject.transform.position;
            orange.transform.rotation = other.gameObject.transform.rotation;
