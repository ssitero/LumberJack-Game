...
public class WhitePickup : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.CompareTag("Player"))
        {
            ...
            white.transform.position = other.gameObject.transform.position;
            white.transform.rotation = other.gameObject.transform.rotation;
